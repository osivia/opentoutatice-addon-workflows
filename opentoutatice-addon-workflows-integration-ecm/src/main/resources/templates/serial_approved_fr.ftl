                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;">
                        ...
                        <p>Le document suivant a &eacute;t&eacute; <strong>approuv&eacute;</strong> par l'ensemble des participants:</p>
                        ...
                        <table cellpadding="6" cellspacing="0" style="border:none;border-collapse:collapse;font-size:13px;">
                          <tbody>
                            <tr>
                              ...
                              <td style="border:1px solid #eee;color:#000;font-size:13px;">${Document.title}
                              </td>
                            </tr>
                            <#assign description = Document.description />
                            ...
                            <tr>
                              ...
                              <td style="border:1px solid #eee;color:#000;font-size:13px;">${Document.created?datetime?string("dd/MM/yyyy - HH:mm")}
                              </td>
                            </tr>
                            <tr>
                              <td style="border:1px solid #eee;color:#888;font-size:13px;white-space:nowrap;">Emplacement</td>
                              <td style="border:1px solid #eee;color:#000;font-size:13px;">${Document.path}</td>
                            </tr>
                          </tbody>
                        </table><br/>
                      </td>
                    ...
                    <tr>
                      <td style="background-color:#f7f7f7;border-top:1px dashed #e9ecef;text-align:center;padding:8px 20px;">
                        ...
                        Ce message vous a &eacute;t&eacute; envoy&eacute; car vous &ecirc;tes inscrit(e) aux notifications de modification de ce document ou d'un de ses dossiers parents.
                        </div>
                      </td>
                    </tr>
                  </tbody>
